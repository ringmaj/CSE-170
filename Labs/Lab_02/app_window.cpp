...
void AppWindow::glutKeyboard ( unsigned char key, int x, int y )
 {
   switch ( key )
    { case ' ': _viewaxis = !_viewaxis; redraw(); break;
	  ...
	  case 'a': nfaces--; redraw(); break;
	 case 'w': rt+=.01; redraw(); break;
	  case 's': rt-=.01; redraw(); break;
	 case 'e': rb+=.01; redraw(); break;
	  case 'd': rb-=.01; redraw(); break;
...
void AppWindow::glutDisplay ()
 {
   ...
   if (_viewaxis) _cap.draw(stransf, sproj);
