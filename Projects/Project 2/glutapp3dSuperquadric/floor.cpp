...
void Floor::createBox(double x0, double y0, double z0, double length, double width, double height, GsArray<GsVec> &P, GsArray<GsColor> &C, GsColor color) {
...
void Floor::build()
{
	...
	//Floor 
	createBox(0.0, -0.37, 0.0, 50, 2.0, 0.5, P, C, GsColor::lightgray);


	// Stairset

	/*createBox(-5.0, 0.3, 0.0, 5.0, 1.0, 1.0, P, C, GsColor::darkgray);
	createBox(-2.5, 0.2, 0.0, 0.3, 1.0, 0.8, P, C, GsColor::green);
	createBox(-2.2, 0.0, 0.0, 0.3, 1.0, 0.6, P, C, GsColor::darkgray);
	createBox(-1.9, -0.2, 0.0, 0.3, 1.0, 0.4, P, C, GsColor::green);*/
	//createBox(-5.0, -0.16, 0.0, 0.5, 2.0, 0.015, P, C, GsColor::lightgray);
...
void Floor::draw(const GsMat& tr, const GsMat& pr, const GsLight& l)
{
	float f[4];
